...
- [x] URL writes are throttled outside the animation hot path
- [x] Main metrics can update continuously in live modes
- [x] Mode changes have the reference-style 1200 ms ease-out count-up
